...
namespace proportionalFont {
    ...
    let fontData: number[] = [1, 185, 24603, 92102485, 19655237, 216566685, 170063685, 25, 4466, 3722, 85189717, 34858021, 6274, 34636837, 129, 25795, 119155, 7954, 186771, 87435, 2353764, 79291, 79219, 32011, 87379, 120211, 81, 6786, 145310757, 86592085, 34687629, 21771, 158839157, 248307, 87547, 143731, 119291, 144891, 9723, 110963, 255227, 147339, 127299, 222459, 135419, 260604669, 8159996, 119155, 17915, 252275, 214523, 79251, 16139, 258299, 63547, 65067069, 222427, 64571, 161227, 4602, 197659, 8074, 49459, 135299, 522, 234563, 70907, 169027, 259139, 170595, 48675, 236195, 197883, 209, 7554, 166139, 4218, 202573029, 197859, 70723, 35571, 248355, 34019, 6818, 171555, 233571, 102499, 104927333, 166051, 121011, 5842, 147235, 249, 40843, 35684901];
    ...
    function getGlyph(code: number) {
        ...
        return fontData[code - 32];
    }

    /**
     * Obtain the width of a character in the font.
     */
    function getGlyphWidth(glyph: number) {
        return glyph & 7;
    }
     ...
     */
    function getColumn(glyph: number, col: number) {
